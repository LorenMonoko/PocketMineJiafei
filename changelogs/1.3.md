...
In Minecraft: PE 0.7.4 you can add External servers directly. [How to add servers](https://github.com/PocketMine/PocketMineJiafei/wiki/How-to-add-servers)
...
Starting with this release, all PocketMineJiafei versions will be given a codename. This one received the codename 「甘いビートルート」_(Amai Beetroot)_.
...
For more information, check the [complete changelog](https://github.com/PocketMine/PocketMineJiafei/compare/Alpha_1.3.10...Alpha_1.3.11).
