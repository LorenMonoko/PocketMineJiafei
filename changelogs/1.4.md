...
This is the first beta in the 1.4 series. This is a complete rewrite of PocketMineJiafei, so only plugins developed for this new API will work.
...
- Moved spl to [PocketMine-SPL](https://github.com/PocketMine/PocketMineJiafei)
...
This is the first stable build of PocketMineJiafei 1.4. Lots of changes have happened since 1.3.12, and they won't be detailed here. You can find them on the release list here on GitHub.
