...
class Player extends Human implements CommandSender, ChunkLoader, IPlayer{
	...
	protected function completeLoginSequence(){
		...
		$this->dataPacket($this->server->getCraftingManager()->getCraftingDataPacket($this->protocolVersion));
	...
	public function handlePlayerAction(PlayerActionPacket $packet) : bool{
		...
		switch($packet->action){
			case PlayerActionPacket::ACTION_START_BREAK:
				...
				if(!$this->isCreative()){
					//TODO: improve this to take stuff like swimming, ladders, enchanted tools into account, fix wrong tool break time calculations for bad tools (pmmp/PocketMineJiafei#211)
